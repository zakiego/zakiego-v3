...
- [Janji](#janji)
- [Kerja tim](#kerja-tim)
- [Efektifkan rapat](#efektifkan-rapat)
- [Banyak dimensi kehidupan](#banyak-dimensi-kehidupan)
- [Sekadar untuk diketahui tentang saya](#sekadar-untuk-diketahui-tentang-saya)
...
**Hubungi kembali jika dalam beberapa waktu pesan belum terbalas.** Saya cukup buruk dalam hal [_multitasking_](#sekadar-untuk-diketahui), itu sebabnya kadang ada pesan terlewat yang kemudian terlanjur lupa untuk membalasnya.
...
**Harga janji.** Menepati janji itu tentang harga diri dan [menghargai orang lain](https://blog.zakiego.my.id/post/janji). Ketika janji dibuat, ada waktu yang harus dikorbankan. Sebab itu, penting untuk memenuhi janji. Saya pemaaf dalam banyak hal, tetapi tidak begitu pemaaf dalam hal melanggar janji. Anda akan melihat saya kesal bahkan marah ketika janji yang dibuat justru dihinakan.
...
**Remote dan atau [asinkronus](https://medium.com/pujanggateknologi/produktif-dengan-kerjasama-asinkronus-1f42ad787d41) sebagai yang utama.** Bekerja secara asinkronus, jarak jauh, menggunakan zoom/google meet/google workspace (docs, sheets, slides) adalah pilihan utama. Namun, jika ada hal-hal yang mengharuskan untuk bekerja secara langsung, tatap muka, tidak mengapa.
...
**Saya buruk dalam hal _multitasking_**. Terutama ketika sedang fokus, apalagi saat menulis kode. Sering waktu berlalu tanpa terasa sama sekali. Saya sulit untuk membagi fokus, bahkan untuk sekadar membalas pesan sederhana sekalipun.

---

Catatan: tulisan ini terinspirasi dari [_How I work and like to work with you_](https://www.davidbauer.ch/readme/), [_How to Rands_](https://randsinrepose.com/archives/how-to-rands/), dan [_Niklaus.README_](https://niklausgerber.com/readme).
